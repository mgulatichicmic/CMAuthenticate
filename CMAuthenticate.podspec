...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mgulatichicmic/CMAuthenticate'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chicmic ' => 'mgulati@chicmic.in' }
  s.source           = { :git => 'https://github.com/mgulatichicmic/CMAuthenticate.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'CMAuthenticate/Classes/**/*'
  s.resources = ['CMAuthenticate/Framework/TwitterKitResources.bundle',
                'CMAuthenticate/Framework/GoogleSignIn.bundle']
